...
export const translations = {
  en: {
    ...
    about: {
      ...
      testimonialsLegend: 'Siân Richards, Makeup designer and Oscar Nominee',
      videoFallback: 'Your browser does not support embedded video.',
      reelControls: 'Reel playback controls',
      reelPlay: 'Play reel',
  ...
  da: {
    ...
    about: {
      ...
      testimonialsAria: 'Udtalelser',
      testimonialsLegend: 'Siân Richards, makeupdesigner og Oscar-nomineret',
      videoFallback: 'Din browser understøtter ikke indlejret video.',
      reelControls: 'Afspilningsknapper til reel',
      reelPlay: 'Afspil reel',
      reelPause: 'Pause reel',
      reelStop: 'Stop reel',
    ...
    subheadlineHome: [
      ...
      'Jeg underviser i kunst og laver Makeup FX',
      'Jeg er din næste...',
      'UX / UI Designer',
      'Content Creator',
  ...
  fr: {
    ...
    about: {
      ...
      testimonialsAria: 'Témoignages',
      testimonialsLegend: 'Siân Richards, maquilleuse et nominée aux Oscars',
      videoFallback: 'Votre navigateur ne prend pas en charge la vidéo intégrée.',
      reelControls: 'Commandes de lecture du reel',
      reelPlay: 'Lire le reel',
      reelPause: 'Mettre le reel en pause',
    ...
    subheadlineHome: [
      ...
      'J’enseigne l’art et je fais du Makeup FX',
  ...
  de: {
    ...
    about: {
      ...
      testimonialsTitle: 'Testimonials',
      testimonialsAria: 'Testimonials',
      testimonialsLegend: 'Siân Richards, Makeup-Designerin und Oscar-Nominierte',
      videoFallback: 'Ihr Browser unterstützt eingebettete Videos nicht.',
      reelControls: 'Reel-Wiedergabesteuerung',
      reelPlay: 'Reel abspielen',
      reelPause: 'Reel pausieren',
    ...
    subheadlineHome: [
      ...
      'Ich unterrichte Kunst und mache Makeup FX',
  ...
  es: {
    ...
    about: {
      ...
      testimonialsLegend: 'Siân Richards, diseñadora de maquillaje y nominada al Oscar',
      videoFallback: 'Tu navegador no admite video incrustado.',
      reelControls: 'Controles de reproducción del reel',
      reelPlay: 'Reproducir reel',
      reelPause: 'Pausar reel',
